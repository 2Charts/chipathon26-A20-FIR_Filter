...
set_output_delay $output_delay_value -clock $clocks $core_outputs
...
set_input_delay -min 0 -clock $clocks $core_inputs
set_input_delay -max $input_delay_value -clock $clocks $core_inputs
